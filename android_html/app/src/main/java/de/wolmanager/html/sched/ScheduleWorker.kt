package de.wolmanager.html.sched
...
import de.wolmanager.html.WolApplication
...
class ScheduleWorker(
    ...
    companion object {
        ...
        suspend fun runAction(
            container: de.wolmanager.html.AppContainer,
            device: Device,
            sched: de.wolmanager.html.data.ScheduleDef,
        ) {
