...
# HEADLESS_MODE, StatusWorker and _active_threads live in wol_app.app_core
# (shared with the modern views / Linux port) and are imported above so the
# classic window keeps working unchanged.
