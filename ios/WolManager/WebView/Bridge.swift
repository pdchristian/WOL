...
final class Bridge: NSObject, WKScriptMessageHandler {
    ...
    private func infoJson() -> [String: Any] {
        [
            "versionName": Bundle.main.infoDictionary?["CFBundleShortVersionString"] as? String ?? "2.3.6",
    ...
    private func updateCheckJson() async throws -> [String: Any] {
        let current = Bundle.main.infoDictionary?["CFBundleShortVersionString"] as? String ?? "2.3.6"
